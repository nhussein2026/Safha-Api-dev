...
// const bgPic = multer({ storage: storage })
// const avatar = multer({ storage: storage })

// router.post('/', isAuthenticated, isAuthorized, avatar.single('avatar'), bgPic.single('bgPic'), controller.store)
// router.post('/', isAuthenticated, isAuthorized, avatar.single('avatar'), controller.store)
